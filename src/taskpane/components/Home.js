    ...
    constructor(props){
      ...
      async   createTable() {
        ...
        bilanEnv.rows.add(null, [
            ...
            ["Élimination des déchets et efforts de l’entreprise pour en limiter la quantité", "Quantité de déchets inertes recyclée", "1", "Taux de déchets inertes non recyclés","=((C2-C3)/C2)*100"],
            ...
            ["Élimination des déchets et efforts de l’entreprise pour en limiter la quantité", "Quantité de déchets industriels non dangereux recyclée", "1", "Taux de déchets industriels non dangereux non recyclés","=((C4-C5)/C4)*100"],
            ...
            ["Élimination des déchets et efforts de l’entreprise pour en limiter la quantité", "Quantité de déchets plastiques recyclée", "1", "Taux de déchets plastiques non recyclés","=((C6-C7)/C6)*100"],
            ...
            ["Élimination des déchets et efforts de l’entreprise pour en limiter la quantité", "Quantité de déchets fermentescibles recyclée", "1", "Taux de déchets fermentescibles non recyclés","=((C8-C9)/C8)*100"],
            ...
            ["Élimination des déchets et efforts de l’entreprise pour en limiter la quantité", "Quantité de déchets d’équipements electroniques et éléctriques recyclée", "1", "Taux de déchets d’équipements electroniques et electriques non recyclés","=((C10-C11)/C10)*100"],
            ...
            ["Réduction des nuisances sonores","Nombre de mesures appliquées pour atténuer les nuisances sonores",  "1", "Taux de nuisance sonore à résoudre","=(1-((C24+C25)/(C21+C22+C23)))*100"],
            ...
            ["Protection de la biodiversité et du paysage","Nombre de bâtiments détruits",  "1", "Quantité restante d’arbres à planter","=(1-(C27)/(C26+C28+C29))*100"],
            ["Protection de la biodiversité et du paysage","Quantité de déchets de chantier de construction produite",  "1", "",""],
            ["Protection de la biodiversité et du paysage","Quantité de déchets de chantier de construction recyclés",  "1", "Quantité de déchets de chantier de construction non recyclée","=((C30-C31)/C30)*100"],
        ]);
        ...
        expensesTable.rows.add(null /*add at the end*/, [
            ...
            // FEVRIER
            ["Fevrier", "Indicateurs de mobilité", "Nombre de sorties", "19","Taux de sortie/d'entrée","=D2/D3"],
            ["Fevrier", "Indicateurs de mobilité", "Nombre d'agents", "200","",""],
            ["Fevrier", "Indicateurs de mobilité", "Nombre d’entrées", "60","Taux de sortie/d'entrée","=D4/D3"],
            ["Fevrier", "Indicateurs de mobilité", "Nombre d'arrivées", "19","",""],
            ["Fevrier", "Indicateurs de mobilité", "Nombre de départs", "3","Ratio de remplacement","=D5/D6"],
            ["Fevrier", "Indicateurs de mobilité", "Effectif", "70","Turn Over","=(D2+D4)/D7"],
            ["Fevrier", "Indicateurs d’intégration", "Nombre moyen d’agents", "60","Taux des départs","=D9/D8"],
            ["Fevrier", "Indicateurs d’intégration", "Nombre de départs annuel", "12","",""],
            ["Fevrier", "Indicateurs d’intégration", "Nombre de démissions / détachement sur l’année", "6","Taux des départs volontaires","=D10/D9"],
            ["Fevrier", "Indicateurs d’intégration", "Nombre des prorogations de stage", "10","",""],
            ["Fevrier", "Indicateurs d’intégration", "Total des mises en stage", "7","Taux des prorogations de stage","=D11/D12"],
            ["Fevrier", "Les indicateurs liés à l’emploi", "Nombre d'agents ayant moins de x ans dans la collectivité ", "20","",""],
            ["Fevrier", "Les indicateurs liés à l’emploi", "Effectif moyen", "100","Taux d'ancienneté dans l'organisation","=D13/D14"],
            ["Fevrier", "Les indicateurs liés au risque maladie", "Nombre de jours d'absence en jour ouvrée ", "70","",""],
            ["Fevrier", "Les indicateurs liés au risque maladie", "Nomdre d'agents de l'effectif", "150","Taux d'absentéisme maladie","=D15/(251*D16)"],
            ["Fevrier", "Les indicateurs liés au risque maladie", "Nombre d'arrêt maladie moins de 4 jours", "50","",""],
            ["Fevrier", "Les indicateurs liés au risque maladie", "Nombre d'arrêt maladie", "60","Taux d'absentéisme maladie de courte durée","=D17/D18"],
            ["Fevrier", "Les indicateurs liés au risque professionnel", "Nombre d'accidents de travail avec arrêt ", "20","Taux de fréquence des accidents du travail","=(D19*10^6)/D20"],
            ["Fevrier", "Les indicateurs liés au risque professionnel", "Nombre d'heures travaillées", "8000","",""],
            ["Fevrier", "Les indicateurs liés au risque professionnel", "Nombre de jours d'arrêt de travail ", "60","Taux de gravité des accidents de travail","=(D21*10^3)/D20"],
            ["Fevrier", "Les indicateurs de la formation professionnelle","Nombre d'agents par catégorie partis en formation en cours d'année", "7","",""],
            ["Fevrier", "Les indicateurs de la formation professionnelle", "Effectif de la catégorie hiérarchique","67","Taux de départ en formation par catégorie","=D22/D23"],
            ["Fevrier", "Les indicateurs de la formation professionnelle", "Montant des dépenses consacrées a la formation","10000","",""],
            ["Fevrier", "Les indicateurs de la formation professionnelle", "Masse salariale","900000","Taux de participation à la formation","=D24/D25"],
            ["Fevrier", "Les indicateurs démographiques","Agents de plus de 55 ans", "12","",""],
            ["Fevrier", "Les indicateurs démographiques","Effectif total", "45","Age","=D26/D27"],
            ["Fevrier", "Les indicateurs démographiques", "Somme des anciennetés des agents","14","Ancienneté","=D28/D27"],
            ["Fevrier", "Les indicateurs liés aux rémunérations","Effectif", "1","",""],
            ["Fevrier", "Les indicateurs liés aux rémunérations","Frais de personnel", "2","Masse salariale 1","=D30/D29"],
            ["Fevrier", "Les indicateurs liés aux rémunérations","Budget de fonctionnement", "3","Masse salariale 2","=D30/D31"],
            ["Fevrier", "Les indicateurs liés aux rémunérations","Salaire des 10 % les plus élevés", "4","",""],
            ["Fevrier", "Les indicateurs liés aux rémunérations","Salaire des 10 % les plus bas", "5","Disparité des salaires entre différentes catégories","=D32/D33"],
